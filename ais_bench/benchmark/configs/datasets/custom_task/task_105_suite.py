...
接下来我会给你发若干个文本，请你从我新发的文本和历史所有文本中(优先考虑新文本的信息)，回答下面的问题：
    ...
    ## 注意事项
    对话中如果一般有“派我”，“发我”一类的描述，一般是师傅领单的对话，这种情况对话中师傅名字没有特别提到一般就是“我”。
...
task_105_reader_cfg = dict(input_columns=["input"], output_column="output")
...
task_105_datasets = [
    dict(
        type=CustomDataset,
        abbr="task_105",
        path="data/custom_task/task_105.jsonl",
        reader_cfg=task_105_reader_cfg,
        infer_cfg=task_105_infer_cfg,
        eval_cfg=task_105_eval_cfg,
    )
]
