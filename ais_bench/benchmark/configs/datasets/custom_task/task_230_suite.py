...
task_230_datasets = [
    dict(
        type=CustomDataset,
        abbr='task_230',
        path='data/custom_task/task_230.jsonl',
        reader_cfg=task_230_reader_cfg,
        infer_cfg=task_230_infer_cfg,
        eval_cfg=task_230_eval_cfg,
    )
]
