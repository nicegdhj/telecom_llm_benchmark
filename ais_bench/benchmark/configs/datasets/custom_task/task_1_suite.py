...
2.提取文本中包含的账号信息，请从以下列表中选择提取项"宽带账号"(格式为首字母非v的五位小写字母+8位数字，例如jhywa57979879；或为a+11位数字)，"密码","手机号","工单号"（cp或者ZJ打头的，例如ZJ-055-20231004101222-0021714）,"机顶盒账号"（首字母v开头的五位小写字母+9位数字,7开头纯数字，例如vwzyq747006593）,"师傅名字", "序列号"。
